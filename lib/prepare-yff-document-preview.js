...
const generateMottaker = require('./yff-generate_mottaker')
...
module.exports = document => {
  ...
  if (['yff-bekreftelse', 'yff-bekreftelse-bedrift'].includes(document.documentCategory)) {
    data.klasseTrinn = document.classLevel
    data.utdanningsProgram = document.utdanningsprogram
    data.navnMottaker = generateMottaker(document)
